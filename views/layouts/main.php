                                ...
                                <div class="list-group list-group-flush list-group-hoverable">
                                    <div class="list-group-item">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col text-truncate">
                                                <a href="#" class="text-body d-block">Pembaruan Sistem</a>
                                                <div class="d-block text-secondary text-truncate mt-n1">
                                                    Fitur Export PDF & Excel telah aktif!
                                                </div>
                                            </div>
                                            <div class="col-auto">
                                    ...
                                    <div class="list-group-item">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col text-truncate">
                                                <a href="#" class="text-body d-block">Pesan HRD</a>
                                                <div class="d-block text-secondary text-truncate mt-n1">
                                                    Selamat datang di Aplikasi Kepegawaian JMC.
                                                </div>
                                            </div>
                                            <div class="col-auto">
